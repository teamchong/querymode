//! Stress tests for QueryMode - large datasets, memory limits, concurrent access.
//!
...
test "stress: invalid magic number" {
    ...
    var bad_buf: [querymode.FOOTER_SIZE + 100]u8 = undefined;
    @memset(&bad_buf, 0);

    // Put wrong magic at the end
    const footer_start = bad_buf.len - querymode.FOOTER_SIZE;
